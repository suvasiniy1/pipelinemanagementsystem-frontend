...
const DealOverView = (props: params) => {
    ...
    const recentActivitesFilters: Array<any> = ["All Activities"].map((item: any) => ({ "name": item, "value": item }))
                                            ...
                                            <div className='tabcard-content'>
                                                <div className='datahighlights-list'>
                                                    <div className='datahighlights-item'>
                                                        <h3>Create Date</h3>
                                                        <div className='datahighlights-datetxt'>{createdDate as any}</div>
                                                    </div>
                                                    <div className='datahighlights-item'>
                                                        <h3>DEAL STAGE</h3>
                                                        <div className='datahighlights-datetxt'>{stageName} ( {pipelineName} Pipeline)</div>
                                                    </div>
                                                    <div className='datahighlights-item'>
                                                                ...
                                                                <Accordion.Item eventKey={"" + index} key={index}>
                                                                    <Accordion.Header>
                                                                        <span className='accoheader-title'>
                                                                            <FontAwesomeIcon icon={faPenToSquare} /> {note.userName} a <span className='accocolortext'> note</span>
                                                                        </span>
