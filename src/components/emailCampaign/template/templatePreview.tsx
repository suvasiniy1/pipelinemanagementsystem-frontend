...
const TemplatePreview = (props:params) => {
  ...
  useEffect(()=>{
    ...
    (headerRef.current as any).innerHTML  = selectedItem.header.content ?? "Your Sample Header";
    (bodyRef.current as any).innerHTML  = selectedItem.body.content ?? "Your Sample Body";
    (footerRef.current as any).innerHTML  = selectedItem.footer.content ?? "Your Sample Footer";
  },[selectedItem])
