    ...
    return (
      <>
        ...
        >
          <Sidenav
            id="sideNav"
            className="sidenav sidenavCollapse"
            expanded={expanded}
          >
            ...
            <Sidenav.Body>
              <Nav className="sidemenu">
                ...
                <Nav.Item
                  eventKey="2"
                  active={selectedNavItem === "Stages"}
                  icon={
                    <div className="nacicon">
                      <FontAwesomeIcon icon={faLocationCrosshairs} />
                    </div>
                  }
                  onSelect={(e) => {
                    navigate("/Stages");
                    setSelectedNavItem("Stages");
                  }}
                >
                ...
                <Nav.Item
                  eventKey="4"
                  active={selectedNavItem === "Activities"}
                  icon={
                    <div className="nacicon">
                ...
                >
                  ...
                  <Dropdown.Item eventKey="3-3" onSelect={(e) => {
                      navigate("/Email");
                      setSelectedNavItem("Email");
                    }}>Email</Dropdown.Item>
                  <Dropdown.Item eventKey="3-4">Campaign</Dropdown.Item>
                </Dropdown>
          ...
          <Container className="maincontent">
            <HeaderComponent
              onExpandCollapseClick={(e: any) => onExpandCollapseClick(e)}
            />
